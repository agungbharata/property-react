  ...
  return (
    ...
    <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-7xl mx-auto">
      ...
      <form >
        ...
        <button className="text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800 w-full bg-blue-600 text-white px-7 py-3" type="submit">Sign In</button>
